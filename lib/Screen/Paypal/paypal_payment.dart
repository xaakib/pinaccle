...
import 'package:hoichoi_clone_app/Http/Paypal/paypal.dart';
...
class PaypalPayment extends StatefulWidget {
  ...
  // const PaypalPayment({Key? key, this.onFinish});
...
class PaypalPaymentState extends State<PaypalPayment> {
  ...
  late String itemName = "${widget.name}";
  late String itemPrice = '${widget.price}';
  int quantity = 1;
